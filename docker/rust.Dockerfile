...
FROM --platform=$BUILDPLATFORM docker.io/library/rust:1@sha256:80302520b7199f0504975bca59a914015e9fee088f759875dbbc238ca9509ee1 AS rust
...
FROM --platform=$BUILDPLATFORM ghcr.io/rust-cross/cargo-xwin:0.21.4@sha256:8bd86f5eb90b822bd82c67ee429c68e48b8122b1119c98ae9d369c899f3ad36f AS cargo-xwin
...
RUN \
  ...
  apt-get update
  apt-get --no-install-recommends install --yes llvm-19 clang-tools-19
EOF
