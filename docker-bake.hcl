...
variable "_base-images" {
  default = {
    linux = {
      ...
      tag = "bookworm-slim"
      digest = "sha256:12c396bd585df7ec21d5679bb6a83d4878bc4415ce926c9e5ea6426d23c60bdc"
      suffixes = ["", "bookworm"]
  ...
  matrix = {
    item = [
      ...
      },
      {
        ...
        digest = "sha256:fb1eebae6d812e6ac49e95e23155120b7242b790588081404693ddac32385328"
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "v0.20.1"
