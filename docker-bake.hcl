...
variable "_base-images" {
  default = {
    linux = {
      ...
      tag = "bookworm-slim"
      digest = "sha256:537bb7422b661ed483951dd9a0a5ce735076cf86217a2b32c4ad3e8d993850a0"
      suffixes = ["", "bookworm"]
    ...
    windows = {
      ...
      tag = "ltsc2025"
      digest = "sha256:597d1295c5e2befadea8ecd8f042aa5a49d0d3c4675bf868f89dad65a7b74fc6"
    ...
    item = [
      {
        ...
        tag = "buildx-stable-1"
        digest = "sha256:c5137fdd77377ea102a2622714df55459fe42e5867ba180bda07291aa7952d9b"
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "buildx-stable-1-rootless"
        digest = "sha256:843a46493fa40fbff56706bdb13da018c2b0d8dafc5de38d0bd94815c541a634"
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "v0.20.1"
