...
variable "_base-images" {
  default = {
    linux = {
      ...
      tag = "bookworm-slim"
      digest = "sha256:df52e55e3361a81ac1bead266f3373ee55d29aa50cf0975d440c2be3483d8ed3"
      suffixes = ["", "bookworm"]
    ...
    windows = {
      ...
      tag = "ltsc2025"
      digest = "sha256:252ba371c2f50ae797d81ae9d87405b55119714817fead9f406218b556e3ddeb"
  ...
  matrix = {
    item = [
      ...
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "v0.24.0"
        digest = "sha256:6eceb8971ce4fceb3daca562832642706238b7eea72941fcf9896c93c3c4a53e"
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "v0.24.0-rootless"
        digest = "sha256:995077ff90af1afff56ff23018699d7511d122b2b111041f2011bd12afd5c0fe"
      },
      {
        # renovate: datasource=docker depName=docker.io/moby/buildkit
        tag = "latest"
