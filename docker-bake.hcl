...
variable "_base-images" {
  default = {
    ...
    windows = {
      ...
      tag = "ltsc2025"
      digest = "sha256:5e9a1be8f0685f35156a524fb8a88b9d36085db12def20eb52e11b0bb1f79a10"
